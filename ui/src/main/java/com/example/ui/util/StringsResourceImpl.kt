...
class StringsResourceImpl @Inject constructor(
    ...
    override val invalidNewPassword: String = getString(R.string.invalid_new_password)
    override val invalidConfirmPassword: String = getString(R.string.invalid_confirm_new_password)
    override val emptyPassword: String = getString(R.string.current_password_cannot_be_empty)
    override val emptyNewPassword: String = getString(R.string.new_password_cannot_be_empty)
    override val emptyConfirmPassword: String = getString(R.string.confirm_password_cannot_be_empty)
    override val sameConfirmPassword: String = getString(R.string.new_password_cannot_be_the_same)
